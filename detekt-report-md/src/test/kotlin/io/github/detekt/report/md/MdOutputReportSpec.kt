...
private fun createTestDetektionWithMultipleSmells(): Detektion {
    ...
    return createMdDetektion(
        createIssue(createRuleInstance("id_a", "Section-1"), entity1, "Issue message 1"),
        createIssue(createRuleInstance("id_a", "Section-1"), entity2, "Issue message 2"),
        createIssue(createRuleInstance("id_b", "Section-2"), entity3, "Issue message 3"),
    ).also {
...
private fun issues(): Array<Issue> {
    ...
    return arrayOf(
        createIssue(createRuleInstance("id_a", "RuleSet1"), entity1),
        createIssue(createRuleInstance("id_a", "RuleSet1"), entity2),
        createIssue(createRuleInstance("id_a", "RuleSet1"), entity3),
        createIssue(createRuleInstance("id_a", "RuleSet1"), entity4),
        createIssue(createRuleInstance("id_b", "RuleSet1"), entity2),
        createIssue(createRuleInstance("id_b", "RuleSet1"), entity1),
        createIssue(createRuleInstance("id_b", "RuleSet1"), entity4),
        createIssue(createRuleInstance("id_b", "RuleSet2"), entity3),
        createIssue(createRuleInstance("id_c", "RuleSet2"), entity1),
        createIssue(createRuleInstance("id_c", "RuleSet2"), entity2),
    )
}
