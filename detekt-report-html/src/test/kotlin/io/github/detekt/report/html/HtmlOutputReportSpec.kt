...
private fun createTestDetektionWithMultipleSmells(): Detektion {
    ...
    return TestDetektion(
        createIssue(createRuleInstance("id_a", "RuleSet1"), entity1, "Issue message 1"),
        createIssue(createRuleInstance("id_a", "RuleSet1"), entity2, "Issue message 2"),
        createIssue(createRuleInstance("id_b", "RuleSet2"), entity3, "Issue message 3"),
    )
}
